...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/baseline/facial_covid_cns.rds")
  )
...
covidcns_dat_id <- covidcns_dat %>% #new dataset with ID
  ...
  select(
         ...
         startDate,
         endDate,
         facial.face_difficulty_move_find,
         facial.smile_mouth_affected_side,
         facial.eyebrows_raise_affected_side,
         facial.mouth_moves_lips_pucker,
         facial.experience_required_start_question
         ) %>%
...
variables_num <- c(
  "facial.face_difficulty_move_find_numeric",
  "facial.smile_mouth_affected_side_numeric",
  "facial.eyebrows_raise_affected_side_numeric",
  "facial.mouth_moves_lips_pucker_numeric",
  "facial.experience_required_start_question_numeric"
)
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/baseline/facial_covidcns_clean.rds")
    )
