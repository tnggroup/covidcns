...
## ----COVID CNS ethnicity data-----------------------------------------------------------------------------------------
ethn <- read_rds(file = 
                   paste0(ilovecovidcns, "/data_raw/latest_freeze/baseline/dem_covid_cns.rds")
                 )
...
## ----imp_check numeric ethnicity variables----------------------------------------------------------------------------
...
## ----imp_check "British, Mixed British" variable----------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Northern Irish" variable------------------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Any other White background" variable------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "White and Black Caribbean" variable-------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "White and Black Africa" variable----------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "White and Asian" variable-----------------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Any other mixed background" variable------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Indian or British Indian" variable--------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Pakistani or British Pakistani" variable--------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Bangladeshi or British Bangladeshi" variable----------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Any other Asian background" variable------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Any other Black Background" variable------------------------------------------------------------------
imp_check(data = ethn_id,
...
## ----imp_check "Any other ethnic group" variable----------------------------------------------------------------------
imp_check(data = ethn_id,
