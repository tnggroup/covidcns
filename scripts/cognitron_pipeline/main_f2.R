...
# Add f2 to colnames
colnames(scores_df_final) <- paste(colnames(scores_df_final), "f2", sep = "_")
...
saveRDS(scores_df_final, paste0(ilovecovidcns, "/data/cognitron/scores/cognitron_scores_and_demographics_f2.rds"))
write.csv(scores_df_final, paste0(ilovecovidcns, "/data/cognitron/scores/cognitron_scores_and_demographics_f2.csv"))
