...
data_cognitron_raw <- read.table(file = paste0(ilovecovidcns, "/data_raw/cognitron/raw_cognitron/followup1/cognitron_f1_data_19.12.2022.tsv"), sep = '\t', header = FALSE)
...
cols_to_filter_above_30K <- c("rs_prospectiveMemoryWords_2_immediate_RT",
                              "rs_spatialSpan_RT", "rs_manipulations2D_RT",
                              "rs_verbalAnalogies_RT", "rs_prospectiveMemoryWords_2_delayed_RT",
                              "rs_motorControl")
...
# Save scores_df_final to cognitron onedrive
...
st_deviation_from_expected_with_users_sub = st_deviation_from_expected_with_users[st_deviation_from_expected_with_users$rs_motorControl_RT_f1_dfe < 3.5,]
...
# FILTER OUT people that perform poorly in MC
deviation_from_expected_sub = deviation_from_expected_with_users[st_deviation_from_expected_with_users$rs_motorControl_RT_f1_dfe < 3.5,]
...
ggsave(p_pred_vs_obs_all, filename = paste0(ilovecovidcns, "/data/cognitron/plots/pred_vs_obs_facets_f1.png"),
...
ggsave(p_pred_vs_obs_decade,
       filename = paste0(ilovecovidcns, "/data/cognitron/plots/pred_vs_obs_facets_decade_f1.png"),
       width = 12, height = 12, dpi = 1000)
...
ggsave(p_pred_vs_obs_sex,
       filename = paste0(ilovecovidcns, "/data/cognitron/plots/pred_vs_obs_facets_sex_f1.png"),
       width = 12, height = 12, dpi = 1000)
...
ggsave(p_pred_vs_obs_edu,
       filename = paste0(ilovecovidcns, "/data/cognitron/plots/pred_vs_obs_facets_education_f1.png"),
       width = 12, height = 12, dpi = 1000)
#
## 7.2 Heatmap ----------------------------
...
{
  png(filename = paste0(ilovecovidcns, "/data/cognitron/plots/difference_from_predicted_heatmap_f1.png"),
...
ggsave(p_pred_vs_obs_demo_avg,
       filename = paste0(ilovecovidcns, "/data/cognitron/plots/observed_vs_predicted_barplot_sem_f1.png"),
       width = 12, height = 12, dpi = 1000
)
...
ggsave(p_pred_vs_obs_demo_box,
       filename = paste0(ilovecovidcns, "/data/cognitron/plots/observed_vs_predicted_violin_boxplot_f1.png"),
       width = 12, height = 12, dpi = 1000
)
...
ggsave(p_pred_vs_obs_together,
       filename = paste0(ilovecovidcns, "/data/cognitron/plots/observed_vs_predicted_barplot_together_f1.png"),
...
DfE_plots(deviation_from_expected, plot_fname = paste0(ilovecovidcns, "/data/cognitron/plots/composite_mean_difference_from_expected_f1.png"))
DfE_plots(st_deviation_from_expected, plot_fname = paste0(ilovecovidcns, "/data/cognitron/plots/task_mean_difference_from_expected_f1.png"))
...
ggsave(
  filename = paste0(ilovecovidcns, "/data/cognitron/plots/p_diff_from_exp_facet_age_f1.png"),
...
ggsave(
  filename = paste0(ilovecovidcns, "/data/cognitron/plots/p_diff_from_exp_facet_task_fix_f1.png"),
...
ggsave(
  filename = paste0(ilovecovidcns, "/data/cognitron/plots/p_diff_from_exp_facet_task_free_f1.png"),
...
ggsave(
  filename = paste0(ilovecovidcns, "/data/cognitron/plots/p_diff_from_exp_facet_task_freey_scatter_f1.png"),
  p_diff_from_exp_facet_task_freey_scatter,
  width = 22, height = 6
)
...
ggsave(
  filename = paste0(ilovecovidcns, "/data/cognitron/plots/p_diff_from_exp_facet_group_freey_scatter_f1.png"),
  p_diff_from_exp_facet_group_freey_scatter,
  width = 16, height = 9
)