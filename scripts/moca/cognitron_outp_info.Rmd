...
covidcns_dat <- read_rds(
  file = paste0(ilovedata, "/data_raw/latest_freeze/covid_cns/moca/cognitron_outp_covid_cns.rds")
  )
...
dat %>%
  saveRDS(
    file = paste0(ilovedata, "/data/latest_freeze/covidcns/cognitron_outp_covidcns_clean.rds")
    )
```
