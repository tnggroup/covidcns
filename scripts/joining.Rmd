...
dem_visionhearing_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/dem_visionhearing_covidcns_clean.rds")
  )
...
### PHH_interimtemp_covidcns_clean
Read in & variable names
```{r PHH_interimtemp_covidcns_clean Read in data & variable names}
PHH_interimtemp_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/PHH_interimtemp_covidcns_clean.rds")
  )
...
Dimensions
```{r PHH_interimtemp_covidcns_clean Dimensions}
PHH_interimtemp_covidcns_clean %>%
  colnames()
```

Select columns for joining
```{r PHH_interimtemp_covidcns_clean Select columns for joining}
...
trauma_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/trauma_covidcns_clean.rds")
  )
...
ncrf_medication_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf_medication_covidcns_clean.rds")
  )
...
ncrf1_comorbid_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf1_comorbid_covidcns_clean.rds")
  )
...
ncrf1_pre_med_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf1_pre_med_covidcns_clean.rds")
  )
...
ncrf1_vital_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf1_vital_covidcns_clean.rds")
  )
