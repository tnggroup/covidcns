...
ncrf1_comorbid_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/neuro_case_report/ncrf1_comorbid_covidcns_clean.rds")
  )
...
ncrf1_vital_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/neuro_case_report/ncrf1_vital_covidcns_clean.rds")
  )
