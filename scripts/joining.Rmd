...
### als_covid_cns
Read in & variable names
```{r als_covid_cns Read in data & variable names}
als_covid_cns <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/als_covid_cns.rds")
  )
...
Dimensions
```{r als_covid_cns Dimensions}
als_covid_cns %>%
  colnames()
```

Select columns for joining
```{r als_covid_cns Select columns for joining}
als_covid_cns_selected <-
  als_covid_cns %>%
  select(
...
fourat_outp_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/fourat_outp_covidcns_clean.rds")
  )
...
moca_inp_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/moca_inp_covidcns_clean.rds")
  )
...
cognitron_outp_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/cognitron_outp_covidcns_clean.rds")
  )
...
moca_outp_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/moca_outp_covidcns_clean.rds")
  )
...
ncrf1_care_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf1_care_covidcns_clean.rds")
  )
...
ncrf1_cic_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf1_cic_covidcns_clean.rds")
  )
...
ncrf1_lab_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf1_lab_covidcns_clean.rds")
  )
...
ncrf2_care_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf2_care_covidcns_clean.rds")
  )
...
ncrf2_lab_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf2_lab_covidcns_clean.rds")
  )
...
ncrf2_vital_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf2_vital_covidcns_clean.rds")
  )
...
ncrf3_compli_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf3_compli_covidcns_clean.rds")
  )
...
ncrf3_diag_covidcns_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/baseline/ncrf3_diag_covidcns_clean.rds")
  )
