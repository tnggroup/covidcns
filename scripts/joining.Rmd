...
COVID_CNS_casecontrol_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/assessment_status/COVID_CNS_casecontrol_clean.rds")
  )
...
COVID_CNS_neuroimaging_metadata_clean <-
  read_rds(
    file = 
      paste0(ilovedata, "/data/latest_freeze/covidcns/assessment_status/COVID_CNS_neuroimaging_metadata_clean.rds")
  )
