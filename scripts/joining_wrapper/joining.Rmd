...
COVID_CNS_casecontrol_clean <-
  read_rds(
    file = 
      paste0(ilovecovidcns, "/data/assessment_status/COVID_CNS_casecontrol_clean.rds")
  )
...
COVID_CNS_neuroimaging_metadata_clean <-
  read_rds(
    file = 
      paste0(ilovecovidcns, "/data/assessment_status/COVID_CNS_neuroimaging_metadata_clean.rds")
  )
...
cognitron <-
  readRDS(
    paste0(ilovecovidcns, "/data/cognitron/scores/cognitron_scores.rds")
  )
