...
covidcns_sumtable <- data_joined %>%
  ...
  # Remove vaccine and noncovid controls
  mutate(across(case_control_vaccine,
                ~case_when(str_detect(case_control_vaccine, "Vaccine") ~ NA_character_,
  ...
  filter(!is.na(Component_global)) %>%
  
  # Window date of inpatient admission
  mutate(
  ...
  tbl_summary(by = case_control_vaccine,
              ...
              label = list(dem.dob_age ~ "Age",
                           ...
                           Component_global ~ "Cognitron Global Score",
                           Component_accuracy ~ "Cognitron Accuracy Score",
                           Component_rt ~ "Cognitron RT Score")
              ) %>%
...
data_joined %>%
  ...
  mutate(
    ncrf1_admission_windowed =
      case_when(ncrf1_admission.date_of_inpatient_admission.txt >= as.POSIXct("2020-03-01") & ncrf1_admission.date_of_inpatient_admission.txt <= as.POSIXct("2020-09-01")  ~ "March 2020 to September 2020",
                
                ncrf1_admission.date_of_inpatient_admission.txt >= as.POSIXct("2020-09-01") & ncrf1_admission.date_of_inpatient_admission.txt < as.POSIXct("2021-03-01")  ~ "September 2020 to March 2021",
                
                ncrf1_admission.date_of_inpatient_admission.txt >= as.POSIXct("2021-03-01") & ncrf1_admission.date_of_inpatient_admission.txt < as.POSIXct("2021-09-01")  ~ "March 2021 to September 2021",
                
                ncrf1_admission.date_of_inpatient_admission.txt >= as.POSIXct("2021-09-01") & ncrf1_admission.date_of_inpatient_admission.txt < as.POSIXct("2022-03-01")  ~ "September 2021 to March 2022",
                #is.na(ncrf1_admission.date_of_inpatient_admission.txt) ~ "Missing",
                #ncrf1_admission.date_of_inpatient_admission.txt < as.POSIXct("2020-03-01") | ncrf1_admission.date_of_inpatient_admission.txt >= as.POSIXct("2022-03-01")  ~ "Other"
                )
    ) %>%
  select(Component_global,
         dem.dob_age,
         dem.sex_at_birth,
         ncrf1_vital.admission_severity_worst_covid19,
         ncrf1_admission_windowed,
