---
title: "COVIDCNS Neuro Additional Outpatient Cleaning Script"
author: "Zain Ahmad"
date: "30/06/2022"
...
# Read in the data: Neuro Additional Questions (Outpatient)
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/core_neuro/neuro_add_outp_covid_cns.rds")
  )
...
exclude_cols_numeric <- c(
  "neuro_add_outp.if_abnormal.txt"
  )
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/core_neuro/neuro_add_outp_covidcns_clean.rds")
    )
```