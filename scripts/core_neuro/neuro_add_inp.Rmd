---
title: "COVIDCNS Neuro Additional Inpatient Cleaning Script"
author: "Zain Ahmad"
date: "30/06/2022"
...
# Read in the data: Neuro Additional Questions (Inpatient)
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/core_neuro/neuro_add_inp_covid_cns.rds")
  )
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/core_neuro/neuro_add_inp_covidcns_clean.rds")
    )
```