...
covidcns_dat <- read_rds(
  file = paste0(ilovedata, "/data_raw/latest_freeze/covid_cns/mh_case_report/moca_covid_cns.rds")
  )
...
dat %>%
  saveRDS(
    file = paste0(ilovedata, "/data/latest_freeze/covidcns/moca_inp_covidcns_clean.rds")
    )
```
