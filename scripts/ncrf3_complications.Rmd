...
covidcns_dat <- read_rds(
  file = paste0(ilovedata, "/data_raw/latest_freeze/covid_cns/neuro_case_report/ncrf3_compli_covid_cns.rds")
  )
...
dat %>%
  saveRDS(
    file = paste0(ilovedata, "/data/latest_freeze/covidcns/ncrf3_compli_covidcns_clean.rds")
    )
```
