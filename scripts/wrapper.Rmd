...
source(knitr::purl("scripts/assessment_status/casecontrol_status.Rmd"))
```

## neuroimaging_metadata
```{r neuroimaging_metadata Cleaning the individual questionnaires}
source(knitr::purl("scripts/assessment_status/neuroimaging_metadata.Rmd"))
```
...
## clinical_frailty
```{r clinical_frailty Cleaning the individual questionnaires, eval=FALSE, include=FALSE}
source(knitr::purl("scripts/neuro_case_report/clinical_frailty.Rmd"))
```

## ncrf_supportive
```{r ncrf_supportive Cleaning the individual questionnaires, eval=FALSE, include=FALSE}
source(knitr::purl("scripts/neuro_case_report/ncrf_supportive.Rmd"))
```
