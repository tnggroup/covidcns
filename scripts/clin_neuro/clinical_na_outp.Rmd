---
title: "COVIDCNS Clinical NA (Outpatient) Cleaning Script"
author: "Zain Ahmad"
date: "30/06/2022"
...
# Read in the data: Clinical Neurological Assessment (Outpatient)
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/clin_neuro/clinical_na_outp_covid_cns.rds")
  )
...
```{r Vector text vars}
variables_text <- c(
  "clinical_na_outp.dysarthria.1",
  "clinical_na_outp.nystagmus.1",
  "clinical_na_outp.if_abnormal_please_describe.txt",
  "clinical_na_outp.other_observations.txt"
)
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/clin_neuro/clinical_na_outp_covidcns_clean.rds")
    )
```