---
title: "COVIDCNS Clinical NA (Inpatient) Cleaning Script"
author: "Zain Ahmad"
date: "30/06/2022"
...
# Read in the data: Clinical Neurological Assessment (Inpatient)
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/clin_neuro/clinical_na_inp_covid_cns.rds")
  )
...
```{r Vector text vars}
variables_text <- c(
  "clinical_na_inp.dysarthria.1",
  "clinical_na_inp.nystagmus.1",
  "clinical_na_inp.if_abnormal_please_describe.txt",
  "clinical_na_inp.other_observations.txt"
)
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/clin_neuro/clinical_na_inp_covidcns_clean.rds")
    )
```