...
covidcns_dat <- read_csv(
  file = paste0(ilovedata, "/data_raw/assessment_status/COVID_CNS_case_control_status_04.03.2022.csv"),
  col_types = list(
...
dat %>%
  saveRDS(
    file = paste0(ilovedata, "/data/assessment_status/COVID_CNS_casecontrol_clean.rds")
    )
```
