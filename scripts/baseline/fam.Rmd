---
title: "COVIDCNS Family History Cleaning Script"
author: "Zain Ahmad"
date: "27/07/2022"
...
# Read in the data: COVIDCNS Family Medical History
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/baseline/fam_covid_cns.rds")
  )
...
variables_cont <- c(
  "fam.brothers_sisters",
  "fam.brothers_sisters.1",
  "fam.brothers_sisters.2",
  "fam.brothers_sisters.3",
  "fam.stroke_diagnosed_coronary_artery.1",
  "fam.stroke_diagnosed_coronary_artery.2",
  "fam.diagnosed_diabetes_type_andor.1",
  "fam.diagnosed_diabetes_type_andor.2",
  "fam.mental_health_disorders_diagnosed",
  "fam.mental_health_disorders_diagnosed.1",
  "fam.mental_health_disorders_diagnosed.2",
  "fam.mental_health_disorders_diagnosed.3",
  "fam.mental_health_disorders_diagnosed.4",
  "fam.mental_health_disorders_diagnosed.5",
  "fam.mental_health_disorders_diagnosed.6",
  "fam.mental_health_disorders_diagnosed.7",
  "fam.mental_health_disorders_diagnosed.8",
  "fam.mental_health_disorders_diagnosed.9",
  "fam.mental_health_disorders_diagnosed.10",
  "fam.mental_health_disorders_diagnosed.11",
  "fam.mental_health_disorders_diagnosed.12",
  "fam.mental_health_disorders_diagnosed.13",
  "fam.mental_health_disorders_diagnosed.14",
  "fam.mental_health_disorders_diagnosed.15",
  "fam.mental_health_disorders_diagnosed.16",
  "fam.mental_health_disorders_diagnosed.17",
  "fam.mental_health_disorders_diagnosed.18",
  "fam.mental_health_disorders_diagnosed.19",
  "fam.mental_health_disorders_diagnosed.20",
  "fam.mental_health_disorders_diagnosed.21",
  "fam.mental_health_disorders_diagnosed.22",
  "fam.mental_health_disorders_diagnosed.23",
  "fam.mental_health_disorders_diagnosed.24",
  "fam.mental_health_disorders_diagnosed.25"
  )
...
dat <- dat %>%
  mutate(across(fam.diagnosed_diabetes_type_andor.2,
                ~case_when(str_detect(fam.diagnosed_diabetes_type_andor.2, "Mother") ~ "1",
                           TRUE ~ .)
                )
         )
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/baseline/fam_covidcns_clean.rds")
    )
```