...
covidcns_dat <- read_rds(
  file = paste0(filepath_data_raw, "/data_raw/2021-07-12/baseline/covid19_covid_cns.rds")
  )
...
covidcns_dat_id %>% 
  ...
  saveRDS(
    file = paste0(filepath_data_raw, "/data/latest_freeze/baseline/covid19_covid_cns_clean.rds")
    )
```
