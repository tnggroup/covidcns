...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/baseline/migraine_covid_cns.rds")
  )
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "data/latest_freeze/baseline/migraine_covidcns_clean.rds")
    )
```