---
title: "Lifetime Anxiety and Depression"
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/baseline/anxdep_covid_cns.rds")
  )
...
View anxdep.felt_sad_blue_depressed
<Note problem here and report on Teams>
```{r View anxdep.felt_sad_blue_depressed values and labels}
attr(dat$anxdep.felt_sad_blue_depressed, "labels")
```
...
```{r Recode anxdep.felt_sad_blue_depressed}
dat %>%
  freq(anxdep.felt_sad_blue_depressed)

dat <- dat %>% 
  mutate(across(
    anxdep.felt_sad_blue_depressed, 
                ~case_when(
                  . == 2 ~ 0,
                  . == 3 ~ -888,
                  TRUE ~ .)))
...
Rename value labels of anxdep.felt_sad_blue_depressed
```{r Relabel anxdep.felt_sad_blue_depressed}
...
# Assign new labels
dat$anxdep.felt_sad_blue_depressed <- set_labels(dat$anxdep.felt_sad_blue_depressed, labels = new_levels_vec)
...
```{r Recheck anxdep.felt_sad_blue_depressed values and labels}
attr(dat$anxdep.felt_sad_blue_depressed, "labels")
```


anxdep.lost_interest_activities_pleasure
```{r View anxdep.lost_interest_activities_pleasure values and labels}
attr(dat$anxdep.lost_interest_activities_pleasure, "labels")
```

```{r Recode anxdep.lost_interest_activities_pleasure}
dat <- dat %>% 
  mutate(across(anxdep.lost_interest_activities_pleasure,
                ~case_when(
                  . == 2 ~ 0,
                  . == 3 ~ -888,
                  TRUE ~ .)))
...
```{r Relabel anxdep.lost_interest_activities_pleasure}
# Named vector of correct labels
new_levels_vec <- c(
  "No" = 0,
  "Yes" = 1,
...
# Assign new labels
dat$anxdep.lost_interest_activities_pleasure <- set_labels(dat$anxdep.lost_interest_activities_pleasure, labels = new_levels_vec)

# Remove labels vector
rm(new_levels_vec)
```

```{r Recheck anxdep.lost_interest_activities_pleasure values and labels}
attr(dat$anxdep.lost_interest_activities_pleasure, "labels")
```


anxdep.felt_worried_tense_period
```{r View anxdep.felt_worried_tense_period values and labels}
attr(dat$anxdep.felt_worried_tense_period, "labels")
```

```{r Recode anxdep.felt_worried_tense_period}
dat <- dat %>% 
  mutate(across(anxdep.felt_worried_tense_period,
                ~case_when(
                  . == 2 ~ 0,
                  . == 3 ~ -888,
                  TRUE ~ .)))
...
```{r Relabel anxdep.felt_worried_tense_period}
# Named vector of correct labels
new_levels_vec <- c(
  "No" = 0,
  "Yes" = 1,
...
# Assign new labels
dat$anxdep.felt_worried_tense_period <- set_labels(dat$anxdep.felt_worried_tense_period, labels = new_levels_vec)

# Remove labels vector
rm(new_levels_vec)
```

```{r Recheck anxdep.felt_worried_tense_period values and labels}
attr(dat$anxdep.felt_worried_tense_period, "labels")
```


anxdep.lot_situation_worried_worry
```{r View anxdep.lot_situation_worried_worry values and labels}
attr(dat$anxdep.lot_situation_worried_worry, "labels")
```

```{r Recode anxdep.lot_situation_worried_worry}
dat <- dat %>% 
  mutate(across(anxdep.lot_situation_worried_worry,
                ~case_when(
                  . == 2 ~ 0,
                  . == 3 ~ -888,
                  TRUE ~ .)))
...
```{r Relabel anxdep.lot_situation_worried_worry}
# Named vector of correct labels
new_levels_vec <- c(
  "No" = 0,
  "Yes" = 1,
...
# Assign new labels
dat$anxdep.lot_situation_worried_worry <- set_labels(dat$anxdep.lot_situation_worried_worry, labels = new_levels_vec)

# Remove labels vector
rm(new_levels_vec)
```

```{r Recheck anxdep.lot_situation_worried_worry values and labels}
attr(dat$anxdep.lot_situation_worried_worry, "labels")
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/baseline/anxdep_covidcns_clean.rds")
    )
```