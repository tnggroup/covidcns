...
# Read in the data: Tinnitus and hearing
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/baseline/tinnitus_covid_cns.rds")
  )
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/baseline/tinnitus_covidcns_clean.rds")
    )
```