---
title: "COVIDCNS COVID19 Symptoms and Treatment Cleaning Script"
author: "Zain Ahmad"
date: "17/05/2022"
...
Add the add_numeric_1 function - used to convert character variables into numeric variables
...
# Read in the data: COVID19: Symptoms and Treatment
Load COVIDCNS data
...
exclude_cols_numeric <- c(
  ...
  "covid19.latest_test_date_enter.txt",
...
covidcns_dat_id <- covidcns_dat %>% #new dataset with ID
  ...
  select(
         ...
         endDate,
         covid19.exact_date_symptoms_start.txt,
         covid19.tested_covid19,
         covid19.what_test_did_you_have,
         covid19.test_positive_covid19,
         covid19.occasion_test_positive_coivd19,
         covid19.latest_test_date_enter.txt,
         ...
         covid19.other.1,
         covid19.please_describe_your_other_symptoms.txt,
         covid19.individual_symptoms_contact_positive
         ) %>%
