---
title: "COVIDCNS Followup 2 Cleaning Script"
author: "Zain Ahmad"
date: "17/07/2024"
...
# Read in the data: COVIDCNS Followup 2
...
# Generate data path
data_path <- "/Users/zainahmad/Library/CloudStorage/OneDrive-SharedLibraries-King'sCollegeLondon/MT-BioResource - Covid-CNS Data Extraction - Extraction/data_raw/2024-07-17/followup2"
...
Add followup tag to all variable names
```{r Add followup tag}
new_colnames <- c(c("ID", "startDate", "endDate"), paste(colnames(dat)[4:ncol(dat)], "followup2", sep = "_"))
...
exclude_cols_numeric <- c(
  paste(variables_text, "followup2", sep = "_")
  )
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/joined/covidcns_followup2_joined.rds")
    )
```