...
ncrf_dat <- read_rds(
  file = paste0(ilovedata, "/data_raw/latest_freeze/covid_cns/neuro_case_report/ncrf_supportive_covid_cns.rds")
  )
...
dat %>% 
  ...
  saveRDS(file = 
            paste0(ilovedata, "/data/latest_freeze/covidcns/ncrf_supportive_covidcns_clean.rds"))
```