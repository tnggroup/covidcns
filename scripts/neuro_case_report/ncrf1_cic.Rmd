...
covidcns_dat <- read_rds(
  file = paste0(ilovedata, "/data_raw/latest_freeze/covid_cns/neuro_case_report/ncrf1_cic_covid_cns.rds")
  )
...
Problem with add_numeric: created new add_numeric_1 function as workaround
...
dat %>%
  saveRDS(
    file = paste0(ilovedata, "/data/latest_freeze/covidcns/ncrf1_cic_covidcns_clean.rds")
    )
```
