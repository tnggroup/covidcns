---
title: "COVIDCNS NCRF2 New Symptoms Cleaning Script"
author: "Zain Ahmad"
date: "02/07/2022"
...
# Read in the data: Neuro Case Report Form Module 2 New Symptoms
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/neuro_case_report/ncrf2_newsymp_covid_cns.rds")
  )
...
```{r Vector text vars}
variables_text <- c(
  "ncrf2_newsymp.stroke.txt",
  "ncrf2_newsymp.new_onset_or_increased_weakness.txt",
  "ncrf2_newsymp.myoclonusjerksother_abnormal_movements.txt",
  "ncrf2_newsymp.seizures.txt",
  "ncrf2_newsymp.trouble_with_speech.txt",
  "ncrf2_newsymp.problems_seeing.txt",
  "ncrf2_newsymp.other.txt",
  "ncrf2_newsymp.any_other_issue_of_significance_to_note.txt"
)
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/neuro_case_report/ncrf2_newsymp_covidcns_clean.rds")
    )
```