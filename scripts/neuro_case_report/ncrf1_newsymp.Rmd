---
title: "COVIDCNS NCRF1 New Symptoms Cleaning Script"
author: "Zain Ahmad"
date: "02/07/2022"
...
# Read in the data: Neuro Case Report Form Module 1 New Symptoms
...
covidcns_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/neuro_case_report/ncrf1_newsymp_covid_cns.rds")
  )
...
```{r Vector text vars}
variables_text <- c(
  "ncrf1_newsymp.stroke.txt",
  "ncrf1_newsymp.new_onset_or_increased_weakness.txt",
  "ncrf1_newsymp.myoclonusjerksother_abnormal_movements.txt",
  "ncrf1_newsymp.seizures.txt",
  "ncrf1_newsymp.trouble_with_speech.txt",
  "ncrf1_newsymp.problems_seeing.txt",
  "ncrf1_newsymp.other.txt",
  "ncrf1_newsymp.any_other_issue_of_significance_to_note.txt",
  "ncrf1_newsymp.central_neurological_complications.1",
  "ncrf1_newsymp.peripheral_neurological_complications.1",
  "ncrf1_newsymp.other_neurological_complications.1",
  "ncrf1_newsymp.cardiac_complications.1",
  "ncrf1_newsymp.renal_complications.1",
  "ncrf1_newsymp.gut_complications.1",
  "ncrf1_newsymp.liver_complications.1",
  "ncrf1_newsymp.diabetes_related_complications.1",
  "ncrf1_newsymp.peripheral_vascular_events.1",
  "ncrf1_newsymp.other_nonneurological_complications.1"           
)
```
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/neuro_case_report/ncrf1_newsymp_covidcns_clean.rds")
    )
```