---
title: "COVIDCNS NCRF1 Care Cleaning Script"
author: "Zain Ahmad"
date: "14/06/2022"
...
# Read in the data: COVIDCNS NCRF1 Supportive Care 
...
covidcns_dat_id <- covidcns_dat %>% #new dataset with ID
  ...
  dplyr::rename(
    ...
    "ncrf1_care.modified_rankin_score_children.txt" = "QID168_TEXT"
  )
...
dat <- dat %>%
  mutate(across(ncrf1_care.overall_duration_of_invasive_ventilation.txt,
                ~case_when(str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "did not have any invasive ventilation during admission - only had non-invasive ventilation - CPAP8") ~ "0",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "6 weeks") ~ "42",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "1 month") ~ "30",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "3 weeks") ~ "21",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "14 DAYS") ~ "14",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "38 days") ~ "38",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "2 months") ~ "60",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "2 weeks") ~ "14",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "09/05/2020") ~ "1",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "09/04/2020-09/05/2020") ~ "30",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "-") ~ "0",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "n") ~ "N/A",
                           str_detect(ncrf1_care.overall_duration_of_invasive_ventilation.txt, "N") ~ "N/A",
                           TRUE ~ .)
                )
         )
...
dat <- dat %>%
  mutate(across(ncrf1_care.modified_rankin_score.txt,
                ~case_when(str_detect(ncrf1_care.modified_rankin_score.txt, "1 - Associated with Long COVID") ~ "1",
                           str_detect(ncrf1_care.modified_rankin_score.txt, "grade 2") ~ "2",
                           str_detect(ncrf1_care.modified_rankin_score.txt, "n") ~ "N/A",
                           str_detect(ncrf1_care.modified_rankin_score.txt, "N") ~ "N/A",
                           TRUE ~ .)
                )
         )
...
dat <- dat %>%
  mutate(across(ncrf1_care.icu_or_high_dependency_unit_admission.txt,
                ~case_when(str_detect(ncrf1_care.icu_or_high_dependency_unit_admission.txt, "28/01/2021 - 31/-1/2021 at Royal Liverpool") ~ "28/01/2021",
                           TRUE ~ .)
                )
         )
...
```{r Define limits}
upper_limit <- as.POSIXct("2022-06-14")
...
dat %>%
  saveRDS(
    file = paste0(ilovecovidcns, "/data/latest_freeze/neuro_case_report/ncrf1_care_covidcns_clean.rds")
    )
```