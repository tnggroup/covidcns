...
source(file = "scripts/scripts/credentials/paths.R")


## ----Covid cns load data MHD------------------------------------------------------------------------------------------
#Need to change filepath when mhd is updated to MHD
mhd_dat <- read_rds(
  file = paste0(ilovecovidcns, "/data_raw/latest_freeze/covid_cns/baseline/mhd_covid_cns.rds")
  )
...
## ----vector categorical variables mhd.depression----------------------------------------------------------------------
...
## ----vector categorical values mhd.depression-------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.depression-------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.postnatalantenatal_depression---------------------------------------------------
...
## ----vector categorical values mhd.postnatalantenatal_depression------------------------------------------------------
...
## ----imp_check categorical variables mhd.postnatalantenatal_depression------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.pmdd----------------------------------------------------------------------------
...
## ----vector categorical values mhd.pmdd-------------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.pmdd-------------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.mania_hypomania_bipolar_or_manicdepression--------------------------------------
...
## ----vector categorical values mhd.mania_hypomania_bipolar_or_manicdepression-----------------------------------------
...
## ----imp_check categorical variables mhd.mania_hypomania_bipolar_or_manicdepression-----------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.anxiety_nerves_or_generalised_anxiety_disorder----------------------------------
...
## ----vector categorical values mhd.anxiety_nerves_or_generalised_anxiety_disorder-------------------------------------
...
## ----imp_check categorical variables mhd.anxiety_nerves_or_generalised_anxiety_disorder-------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.social_anxiety_or_social_phobia-------------------------------------------------
...
## ----vector categorical values mhd.social_anxiety_or_social_phobia----------------------------------------------------
...
## ----imp_check categorical variables mhd.social_anxiety_or_social_phobia----------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.specific_phobia-----------------------------------------------------------------
...
## ----vector categorical values mhd.specific_phobia--------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.specific_phobia--------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.agoraphobia---------------------------------------------------------------------
...
## ----vector categorical values mhd.agoraphobia------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.agoraphobia------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.panic_attacks-------------------------------------------------------------------
...
## ----vector categorical values mhd.panic_attacks----------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.panic_attacks----------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.panic_disorder------------------------------------------------------------------
...
## ----vector categorical values mhd.panic_disorder---------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.panic_disorder---------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.ptsd----------------------------------------------------------------------------
...
## ----vector categorical values mhd.ptsd-------------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.ptsd-------------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.obsessivecompulsive_disorder_---------------------------------------------------
...
## ----vector categorical values mhd.obsessivecompulsive_disorder_------------------------------------------------------
...
## ----imp_check categorical variables mhd.obsessivecompulsive_disorder_------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.bdd-----------------------------------------------------------------------------
...
## ----vector categorical values mhd.bdd--------------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.bdd--------------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.other_ocd-----------------------------------------------------------------------
...
## ----vector categorical values mhd.other_ocd--------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.other_ocd--------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.none_of_the_above---------------------------------------------------------------
...
## ----vector categorical values mhd.none_of_the_above------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.none_of_the_above------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.dont_know-----------------------------------------------------------------------
...
## ----vector categorical values mhd.dont_know--------------------------------------------------------------------------
...
## ----imp_check categorical variables mhd.dont_know--------------------------------------------------------------------
imp_check(data = dat,
...
## ----vector categorical variables mhd.prefer_not_to_answer------------------------------------------------------------
...
## ----vector categorical values mhd.prefer_not_to_answer---------------------------------------------------------------
...
## ----imp_check categorical variables mhd.prefer_not_to_answer---------------------------------------------------------
imp_check(data = dat,
...
## ----vector numeric variables 0_1 mental------------------------------------------------------------------------------
...
## ----imp_check numeric variables 0_1 mental---------------------------------------------------------------------------
imp_check(data = dat,
...
## ----Creating mental health illness variable--------------------------------------------------------------------------
dat <- dat %>%
  mutate(
...
dat %>% 
  ...
  saveRDS(file = 
            paste0(ilovecovidcns, "/data/latest_freeze/covidcns/past_medical_history_mental_health_covidcns_clean.rds"))
